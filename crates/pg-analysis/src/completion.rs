...
const SQL_KEYWORDS: &[&str] = &[
    ...
    "BEGIN", "BETWEEN", "BY",
    "CASCADE", "CASE", "CHECK", "COLUMN", "COMMIT", "CONCURRENTLY",
    "CONSTRAINT", "COPY", "COST", "CREATE", "CROSS",
    "DATABASE", "DEALLOCATE", "DEFAULT", "DEFINER", "DELETE", "DESC",
    "DISTINCT", "DOMAIN", "DROP",
    "ELSE", "END", "EXCEPT", "EXCLUDING", "EXECUTE", "EXISTS",
    "EXPLAIN", "EXTENSION",
    "FALSE", "FETCH", "FOREIGN", "FROM", "FULL", "FUNCTION",
    "GRANT", "GROUP",
    "HAVING",
    "IF", "ILIKE", "IMMUTABLE", "IN", "INCLUDING", "INDEX", "INHERITS",
    "INNER", "INSERT", "INTERSECT", "INTO", "INVOKER", "IS",
    "JOIN",
    "KEY",
    "LANGUAGE", "LEFT", "LIKE", "LIMIT", "LISTEN",
    "MATERIALIZED",
    "NOT", "NOTIFY", "NULL",
    "OFFSET", "ON", "OR", "ORDER", "OUTER", "OWNER",
    "PARALLEL", "PARTITION", "PREPARE", "PRIMARY", "PROCEDURE",
    "REFERENCES", "REFRESH", "REINDEX", "RENAME", "REPLACE",
    "RESTRICT", "RESTRICTED", "RETURNING", "RETURNS", "REVOKE",
    "RIGHT", "ROLLBACK", "ROWS",
    "SAFE", "SCHEMA", "SECURITY", "SELECT", "SEQUENCE", "SET",
    "STABLE", "STRICT",
    "TABLE", "TABLESPACE", "THEN", "TO", "TRIGGER", "TRUE",
    "TRUNCATE", "TYPE",
    "UNION", "UNIQUE", "UNSAFE", "UPDATE", "USING",
...
fn symbol_kind_to_completion(kind: SymbolKind) -> CompletionKind {
    match kind {
        ...
        SymbolKind::Index | SymbolKind::Trigger | SymbolKind::Extension
        | SymbolKind::Role | SymbolKind::Policy | SymbolKind::Publication
